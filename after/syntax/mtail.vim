...
syn case ignore
syn keyword mtailWordsUncontained   next stop hidden const by del after else
...
syn match mtailSetTime "settime(.*) " contains=@mtailOperators
syn match mtailStrpTime "strptime(.*) " contains=@mtailOperators
